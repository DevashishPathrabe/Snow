...
var f=true;
window.createSnow=function(a,b){if(j){var c=[],m=setInterval(function(){
    f&&b>c.length&&Math.random()<b*0.0025&&c.push(new i(a));
    !f&&!c.length&&clearInterval(m);
    for(var e=h().top,n=l(),d=c.length-1;d>=0;d--)if(c[d])
...
createEl:function(a,b){
    ...
    if(this.left<0)this.left=this.maxLeft;
        ...
        this.el.style.left=Math.round(this.left)+"px"},remove:function(){
